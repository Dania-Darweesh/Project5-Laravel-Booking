        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    <h4>You can add reservation here</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-10 col-md-6 col-sm-6 col-xs-12 m-auto">
                                <div class="form-group">
                                    ...
                                    <input name="room_id" type="number" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="number_of_days" type="number" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="checkin_date" class="form-label">Checkin Date</label>
                                    <input name="checkin_date" type="date" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="total_adults" type="number" class="form-control">
                                </div>
